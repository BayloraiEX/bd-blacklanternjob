...
if Config.InventorySystem == 'ox' then
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addSpecialOmelette', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_alamoomelette', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addDeerSteak', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_deersteak', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addTomatoSoup', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_tomatosoup', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addChips1', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_chips1', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addChips2', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_chips2', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addChips3', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_chips3', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addCalamari', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_calamari', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addBuffaloWings', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_buffalowings', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addPotatoWedges', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_potatowedges', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
    ...
    RegisterNetEvent('bd-blacklanternjob:server:addChickenTenders', function()
        ...
        if not ox_inventory:RemoveItem(src, 'bl_supplies', 1, false) then
            ...
            ox_inventory:AddItem(src, 'bl_chickentenders', 6)
            lib.notify(source, {
                id = 'black_lantern',
                title = 'Black Lantern',
